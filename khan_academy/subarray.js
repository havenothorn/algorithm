...
//  "index" has value 4
println(
  "The index of the minimum value of the subarray starting at index 2 is " +
    index +
    "."
);
Program.assertEqual(index, 4);

var array = [34, 67, 8, 3, 4, 1, 7];
var index = indexOfMinimum(array, 6);

Program.assertEqual(index, 6);

var array = [1, 6, 66, 44, 9, 22, 14];
var index = indexOfMinimum(array, 1);
